...
module.exports = {
  /**
   * Do not modify the list order below
   */
  plugins: [
    /**
     ...
     * @link https://www.npmjs.com/package/eslint-plugin-sort-class-members
     */
    'sort-class-members',
  ],
  env: {
  ...
  overrides: [
    ...
    },
    {
      ...
      rules: {
        /**
         * indent has an error in a ts, vue or tsx file
         */
        'indent': 'off',
        'new-cap': 'off',
        'no-undef': 'off',
    ...
    },
    {
      ...
      rules: {
        /**
         * in testing no need to prohibit using magic numbers
         */
        'no-magic-numbers': 'off',
        /**
         * using nested callbacks frequently in testing
         */
        'max-nested-callbacks': 'off',
        /**
         * "no-undef" is buggy in a ts file
         */
        'no-undef': 'off',
      },
    },
  ...
  rules: {
     ...
     * @link https://github.com/vuejs/eslint-plugin-vue/blob/master/docs/rules/mustache-interpolation-spacing.md
     */
